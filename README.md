...
- **Динамичность**  
   ...
   - Модифицируется через:
     ...
     ```
     💡Эксперементы по использованию `chrt` можно изучить [***здесь***](./chrt_experements.md) 
...
- **Статичность**
   ...
   - Модифицируется через:
     ...
     ```
     💡Эксперементы по использованию `nice` можно изучить [***здесь***](./nice_experements.md) 
...
```
Также можно использовать программную реализацию, представленную в файле [*`sched_pid_info.c`*](./sched_pid_info.c)
...
Will be stuck in this state:
      ...
      └───────┘     └───────┘
             ...
             └───────┘
```
Ранее был проведен эксперемент, вызывающий такое состояние (см. [*chrt_experement.md "Эксперимент 4"*](./priorities/chrt_experement.md))
...
💡Эксперементы с политиками планирования можно изучить [***здесь***](./policy_experiments.md) 